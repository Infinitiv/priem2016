...
#     errors[:not_agreed_target_entrants] = find_not_agreed_entrants(applications)
  ...
  def generate_contracts
    competitive_groups.where(education_source_id: 15).each do |competitive_group|
