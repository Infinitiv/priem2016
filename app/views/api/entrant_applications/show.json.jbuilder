json.entrant_application @entrant_application, :id, :application_number, :campaign_id, :entrant_last_name, :entrant_first_name, :entrant_middle_name, :benefit, :olympionic, :budget_agr, :paid_agr, :status_id, :comment
